...
using NatCamU.Core;
    ...
    public class NATMarkerDetector : NatCamBehaviour
    {
        public Camera cam;
    ...
    public override void Start()
        ...
        public override void OnFrame()
        {
            ...
            img = ARucoUnityHelper.TextureToMat(ARucoUnityHelper.ToTexture2D(preview.texture), TextureParameters);

            DetectMarkers(img);

            //preview.texture = ARucoUnityHelper.MatToTexture(img, ARucoUnityHelper.ToTexture2D(preview.texture));
